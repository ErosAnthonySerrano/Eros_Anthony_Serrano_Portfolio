...
const PersonalInfo = () => {
  return (
    <div className="flex flex-col gap-6 p-8 bg-surface border border-border rounded-2xl overflow-hidden w-full z-10">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-surface-light border border-border rounded-2xl overflow-hidden p-4 flex flex-col gap-2">
