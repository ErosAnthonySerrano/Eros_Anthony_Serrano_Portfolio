  ...
  const commands: Record<string, React.ReactNode | (() => void)> = {
    ...
    merge: (
      <div className="space-y-3">
        <h3 className="text-accent font-semibold">
          Git Merge Status:{" "}
          <span className="text-red-400">Conflict detected</span>
        </h3>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="text-subtle">Replacing developers</span>
          </div>
          <div className="flex justify-between text-sm">
    ...
    backend: (
      <div className="space-y-3">
        <div className="flex items-center space-x-2">
          <span className="text-2xl">⚙️</span>
          <h3 className="text-accent font-semibold">
            Backend Status: <span className="text-yellow-400">It's complicated</span>
          </h3>
        </div>
